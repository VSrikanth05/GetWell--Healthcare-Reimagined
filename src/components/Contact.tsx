    ...
    <div id="contact" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <div className="mb-10">
              <h2 className="text-sm uppercase font-bold tracking-wider text-blue-500 mb-3">Get in touch</h2>
              <h3 className="text-3xl md:text-4xl font-bold mb-4">Ready to get started?</h3>
              <p className="text-xl text-gray-600">
                Schedule a demo or speak with our team about how GetWell can transform your healthcare practice.
              </p>
            </div>
          ...
          <div className="bg-blue-50 rounded-2xl p-8 md:p-12">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="mailto:contact@getwell.ai" className="text-blue-600 font-medium">contact@getwell.ai</a>
                </div>
              </div>
            ...
            {/* Office Hours */}
            <div className="mt-10">
              <h5 className="font-medium text-gray-700 mb-3">Office hours</h5>
              <div className="space-y-2">
            ...
            <div className="mt-10">
              ...
              <div className="flex space-x-4">
                <a href="#" className="h-10 w-10 rounded-full bg-white flex items-center justify-center hover:bg-gray-100 transition-colors">
